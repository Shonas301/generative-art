...
# import clustering from generative_art when available
try:
    from generative_art.flow_field import ClusteringConfig, PointClusterer
...
class GrassGenerator:
    ...
    def _generate_clustered_points(
        ...
        from generative_art.flow_field import Obstacle

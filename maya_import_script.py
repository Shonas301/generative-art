...
assumes the generative-art repo is located at C:/Users/<username>/Documents/generative-art
...
def setup_path() -> None:
    """add generative-art src to python path."""
    # construct path to generative-art/src on windows
    documents = Path(os.path.expanduser("~")) / "Documents"
    generative_art_src = documents / "generative-art" / "src"

    src_path = str(generative_art_src)

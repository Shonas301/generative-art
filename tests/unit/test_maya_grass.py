"""Unit tests for maya_grass module.
...
from maya_grass.generator import GrassGenerator, GrassPoint
from maya_grass.terrain import DetectedObstacle, TerrainAnalyzer, TerrainBounds

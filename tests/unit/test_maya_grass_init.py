"""Unit tests for maya_grass module initialization and validation."""
...
import maya_grass
from maya_grass import _validate_params, generate_grass
...
class TestValidateMeshExists:
    ...
    def teardown_method(self) -> None:
        ...
        # clear cached imports in maya_grass so next test gets fresh mocks
        if "maya_grass" in sys.modules:
    ...
    def test_missing_mesh_raises(self) -> None:
        ...
        from maya_grass import _validate_mesh_exists  # noqa: PLC0415
...
class TestGetUniqueNetworkName:
    ...
    def test_first_name_available(self) -> None:
        ...
        # lazy import required to get mocked maya.cmds
        from maya_grass import _get_unique_network_name  # noqa: PLC0415
...
class TestImportWithoutMaya:
    ...
    def test_validate_params_works_without_maya(self) -> None:
        ...
        _validate_params(1000, (0.5, 1.5))  # should not raise

    def test_module_docstring_exists(self) -> None:
        """Module should have a docstring with usage examples."""
        assert maya_grass.__doc__ is not None
        assert "Quick Start" in maya_grass.__doc__
        assert "generate_grass" in maya_grass.__doc__

    def test_can_import_all_exports(self) -> None:
        """All items in __all__ should be importable."""
        for name in maya_grass.__all__:
            obj = getattr(maya_grass, name)
